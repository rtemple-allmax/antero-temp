...
@Component({
  selector: 'ant-work-order-misc-modal',
  templateUrl: './work-order-misc-modal.component.html',
  styles: [],
})
export class WorkOrderMiscModalComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public record: Nullable<WorkOrderMisc>;
  ...
  public ngOnInit(): void {
    ...
    this.subs.push(this.workStore.selectedMisc$.subscribe(x => this.record = x));
  }
