...
@Component({
  selector: 'ant-work-history-panel-task',
  templateUrl: './work-history-panel-task.component.html',
  styleUrls: ['./work-history-panel-task.component.scss'],
})
export class WorkHistoryPanelTaskComponent extends WorkHistoryPanelBaseComponent implements AfterViewInit {
