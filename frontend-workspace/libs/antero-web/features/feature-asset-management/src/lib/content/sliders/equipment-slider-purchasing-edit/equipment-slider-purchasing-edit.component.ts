...
@Component({
  selector: 'ant-equipment-slider-purchasing-edit',
  templateUrl: './equipment-slider-purchasing-edit.component.html',
  styleUrls: ['./equipment-slider-purchasing-edit.component.scss'],
})
export class EquipmentSliderPurchasingEditComponent extends EquipmentFormBaseComponent implements OnInit {
