...
export class PurchaseOrderPartColumnDefinition extends BaseColumnDefinition {
  constructor(visibleCols?: string[]) {
    super();

    this.columns = [
      new DataColumn('id', { allowSearch: false }),
      new DataColumn('purchaseOrderID', { allowSearch: false }),
      new DataColumn('purchaseOrder.orderDate', { dataType: 'date' }),
      new DataColumn('purchaseOrder.purchaseOrderNumber'),
      new DataColumn('purchaseOrder.requistionNumber'),
      new DataColumn('purchaseOrder.supplier.name'),
      new DataColumn('partQuantity.part.name'),
      new DataColumn('partQuantity.part.description'),
      new DataColumn('partQuantity.warehouse.name'),
      new DataColumn('partQuantity.area.name'),
      new DataColumn('itemNumber'),
      new DataColumn('orderUnit'),
      new DataColumn('unitCost'),
      new DataColumn('quantityOrdered'),
      new DataColumn('quantityReceived')
